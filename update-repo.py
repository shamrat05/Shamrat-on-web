...
# --- CONFIG ---
REPO_URL = "git@github.com:shamrat05/Shamrat-on-web.git"
LOCAL_DIR = r"C:\Users\samra\Downloads\Shamrat-on-web"
...
delete_msg = input("Enter commit message for deletion: ")
run(f'git commit -m "{delete_msg}"', cwd=LOCAL_DIR)
...
upload_msg = input("Enter commit message for upload: ")
run(f'git commit -m "{upload_msg}"', cwd=LOCAL_DIR)
run("git push origin main", cwd=LOCAL_DIR)
