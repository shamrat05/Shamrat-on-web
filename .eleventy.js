...
module.exports = function(eleventyConfig) {
  ...
  console.log('📁 Output directory:', eleventyConfig.dir?.output || '_site');
  console.log('📄 Template formats:', eleventyConfig.templateFormats || ['md', 'njk', 'html']);
  console.log('🔗 Collections:', Object.keys(eleventyConfig.collections || {}));
